        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white overflow-x-hidden antialiased min-h-screen flex flex-col relative">
            ...
            <header className="relative z-10 flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-[#2c2348] px-6 lg:px-10 py-4 bg-white/50 dark:bg-[#151122]/50 backdrop-blur-md">
                ...
                <div className="flex items-center gap-4">
                    <span className="hidden sm:inline-block text-sm text-slate-500 dark:text-[#a092c9]">Already have an account?</span>
                    <Link to="/login">
            ...
            <main className="relative z-10 flex flex-1 flex-col items-center justify-center p-4 py-12">
                <div className="w-full max-w-[520px] rounded-2xl bg-white/80 dark:bg-[#201933]/60 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl overflow-hidden">
                    <div className="bg-slate-5 dark:bg-[#2c2348]/50 px-8 py-4 border-b border-slate-100 dark:border-[#3f3267]/50">
                        <div className="flex justify-between items-center mb-2">
                            <p className="text-slate-500 dark:text-[#a092c9] text-xs font-bold uppercase tracking-wider">Registration</p>
                            <p className="text-slate-500 dark:text-[#a092c9] text-xs font-bold">Step 1 of 2</p>
                        </div>
                        <div className="w-full h-1.5 bg-slate-200 dark:bg-[#3f3267] rounded-full overflow-hidden">
                    ...
                    <div className="p-8 sm:p-10 flex flex-col gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-slate-500 dark:text-[#a092c9] text-sm">Start translating sign language in real-time.</p>
                        </div>
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                            <div className="flex flex-col gap-1.5">
                                <label className="text-slate-900 dark:text-white text-sm font-semibold" htmlFor="fullname">Full Name</label>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <p className="text-xs text-slate-400 dark:text-[#a092c9]/80 pl-1">Must be at least 8 characters</p>
                            </div>
                            <button type="submit" className="mt-4 w-full h-12 bg-primary hover:bg-primary/90 text-white font-bold rounded-full shadow-lg shadow-primary/25 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2">
                        ...
                        <div className="relative py-2">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white dark:bg-[#1f1931] px-4 text-slate-400 dark:text-[#a092c9]">Or continue with</span>
                            </div>
                        </div>
                        ...
                        <div className="sm:hidden text-center mt-2">
                            <span className="text-sm text-slate-500 dark:text-[#a092c9]">Already have an account? <Link to="/login" className="text-primary hover:underline font-bold">Sign In</Link></span>
                        </div>
                    </div>
                </div>
                <div className="mt-8 text-center max-w-sm">
                    <p className="text-xs text-slate-400 dark:text-[#a092c9]/60">
                        By clicking "Create Account", you agree to our
                        <a className="hover:text-primary transition-colors underline decoration-dotted ml-1" href="#">Terms of Service</a>
                        and
                        <a className="hover:text-primary transition-colors underline decoration-dotted ml-1" href="#">Privacy Policy</a>.
                    </p>
                </div>
            </main>
        </div>
